...
(4, 1, 'zee', '$2y$12$FvHpopPczSfmusz4Y7NKj.yHkZTpH5ep19PEmeRNfOhx6U6CoGg7S', '200101122020022022', '081299998888', 'zee@gmail.com', 'zee zee', '', '2024-11-30 19:38:54', '2024-11-30 19:38:54');
...
INSERT INTO `m_jenis_tugas` (`id_jenis_tugas`, `jenis_tugas`) VALUES
(1, 'Membersihkan'),
(2, 'Mengatur Arsip'),
(3, 'Memperbaiki Inventaris'),
(4, 'Input Data'),
(5, 'Menyusun Buku');
...
INSERT INTO `m_tugas_kompen` (`id_tugas_kompen`, `nama_tugas`, `deskripsi`, `status`, `tanggal_mulai`, `tanggal_selesai`, `jam_kompen`, `pemberi_tugas`, `kuota`, `id_jenis_tugas`) VALUES
(1, 'Membersihkan Ruang Kelas', 'Membersihkan kelas B3 sebelum ujian.', 'dibuka', '2024-12-01 10:00:00', '2024-12-01 12:00:00', '2', 'Dosen A', 5, 1),
(2, 'Mengatur Arsip', 'Membantu mengatur dokumen di ruang administrasi.', 'dibuka', '2024-12-02 09:00:00', '2024-12-02 12:00:00', '3', 'Dosen B', 3, 2),
(3, 'Memperbaiki Inventaris', 'Mengecek dan memperbaiki peralatan laboratorium.', 'dibuka', '2024-12-03 13:00:00', '2024-12-03 17:00:00', '4', 'Tendik C', 2, 3),
(4, 'Input Data', 'Menginput data mahasiswa baru ke sistem.', 'dibuka', '2024-12-04 08:00:00', '2024-12-04 09:30:00', '1.5', 'Admin D', 4, 4),
(5, 'Menyusun Buku Perpustakaan', 'Mengelompokkan buku-buku di perpustakaan sesuai kategori.', 'dibuka', '2024-12-05 11:00:00', '2024-12-05 13:00:00', '2', 'Dosen E', 6, 5);
...
--
ALTER TABLE `m_alpha`
  MODIFY `id_alpha` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
