...
<div class="card card-outline card-primary">
    ...
    <div class="card">
        <div class="card-body" style="background-color: #28A745; color: white;">
            Selamat datang dosen/tendik Fifi Novitasari
        </div>
    </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="info-box bg-primary">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Total Mahasiswa Kompen</span>
                        <span class="info-box-number">{{ $data['totalMahasiswaKompen'] }} Orang</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="info-box bg-info">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Yang Masih Proses</span>
                        <span class="info-box-number">{{ $data['mahasiswaProses'] }} Orang</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-12">
                <div class="info-box bg-success">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Yang Sudah Selesai</span>
